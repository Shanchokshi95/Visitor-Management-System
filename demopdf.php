   ...
   require_once('tcpdf/tcpdf.php');
     ...
     while($row = mysqli_fetch_array($res))
     {
      ...
      $filepath = $path.$filename;
       $obj_pdf->Image($filepath,15,55,30,30);

       $obj_pdf->cell(40,10,'',0,0);
       $obj_pdf->cell(40,10,'Visitor Name:',0,0);
       $obj_pdf->cell(20,10,$row['visitor_name'],0,1);

       $obj_pdf->cell(60,13,'Company Name:',0,0);
       $obj_pdf->cell(70,13,$row['visitor_company_name'],0,1);

       $obj_pdf->cell(60,13,'Employee Name:',0,0);
       $obj_pdf->cell(70,13,$row['visitor_name'],0,1);

       $obj_pdf->cell(60,13,'Meeting Time:',0,0);
       $obj_pdf->cell(70,13,$row['visitor_meeting_time'],0,1);

       $obj_pdf->cell(60,13,'Exit Time:',0,0);
       $obj_pdf->cell(70,13,'',0,1);

       $obj_pdf->cell(60,20,'Signature',0,1);
      ...
      // $obj_pdf->SetAutoPageBreak(TRUE, PDF_MARGIN_BOTTOM);
       ...
       $obj_pdf->cell(70,10,'',0,0);
       $obj_pdf->cell(75,10,'VISITOR',0,1);
